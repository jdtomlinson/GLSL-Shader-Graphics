...
void DebugGraphicsPoint::SetVertices()
{
	...
	m_glRenderer.SetVBO( &m_visibleVBOid, m_visibleVertices );
	...
	m_glRenderer.SetVBO( &m_dualDepthShadowVBOid, m_dualDepthShadowVertices );
}
...
void DebugGraphicsPoint::Render()
{
	...
	m_glRenderer.SetLineWidth( LINE_WIDTH );

	if( m_depthSetting == DUAL_DEPTH )
	{
		m_glRenderer.DisableDepthTest();

		m_glRenderer.BindBuffer( m_dualDepthShadowVBOid );
		m_material->Enable();
		m_glRenderer.RenderVertices( m_dualDepthShadowVertices, LINES );
		m_material->Disable();
	...
	if( m_depthSetting == DEPTH_OFF )
	{
		...
		m_glRenderer.BindBuffer( m_visibleVBOid );
		m_material->Enable();
		m_glRenderer.RenderVertices( m_visibleVertices, LINES );
		m_material->Disable();
...
void DebugGraphicsLine::Render()
{
	...
	{
		m_glRenderer.DisableDepthTest();
		m_glRenderer.SetColor4f( 1.f, 1.f, 1.f, DUAL_DEPTH_ALPHA );

		m_glRenderer.BeginRender( LINES );
		{
			m_glRenderer.SetVertex3f( m_startPosition.x, m_startPosition.y, m_startPosition.z );
			m_glRenderer.SetVertex3f( m_endPosition.x, m_endPosition.y, m_endPosition.z );
		}
	...
	if( m_depthSetting == DEPTH_OFF )
	{
		...
		m_glRenderer.BeginRender( LINES );
		{
			m_glRenderer.SetColor4f( m_startColor.r, m_startColor.g, m_startColor.b, m_startColor.a );
			m_glRenderer.SetVertex3f( m_startPosition.x, m_startPosition.y, m_startPosition.z );

			m_glRenderer.SetColor4f( m_endColor.r, m_endColor.g, m_endColor.b, m_endColor.a );
			m_glRenderer.SetVertex3f( m_endPosition.x, m_endPosition.y, m_endPosition.z );
		}
		m_glRenderer.EndRender();
...
void DebugGraphicsAxis::Render()
{
	...
	m_glRenderer.Translatef( m_position.x, m_position.y, m_position.z );
	m_glRenderer.SetLineWidth( LINE_WIDTH );
	...
	if( m_depthSetting == DUAL_DEPTH )
	{
		...
		m_glRenderer.BeginRender( LINES );
		{
			...
			m_glRenderer.SetVertex3f( m_length, 0.f, 0.f );

			m_glRenderer.SetVertex3f( 0.f, 0.f, 0.f );
			m_glRenderer.SetVertex3f( 0.f, m_length, 0.f );

			m_glRenderer.SetVertex3f( 0.f, 0.f, 0.f );
			m_glRenderer.SetVertex3f( 0.f, 0.f, m_length );
		}
		m_glRenderer.EndRender();
	...
	if( m_depthSetting == DEPTH_OFF )
	{
		...
		m_glRenderer.BeginRender( LINES );
		{
			m_glRenderer.SetColor3f( 1.f, 0.f, 0.f );
			m_glRenderer.SetVertex3f( 0.f, 0.f, 0.f );
			m_glRenderer.SetVertex3f( m_length, 0.f, 0.f );

			m_glRenderer.SetColor3f( 0.f, 1.f, 0.f );
			m_glRenderer.SetVertex3f( 0.f, 0.f, 0.f );
			m_glRenderer.SetVertex3f( 0.f, m_length, 0.f );

			m_glRenderer.SetColor3f( 0.f, 0.f, 1.f );
			m_glRenderer.SetVertex3f( 0.f, 0.f, 0.f );
			m_glRenderer.SetVertex3f( 0.f, 0.f, m_length );
		}
		m_glRenderer.EndRender();
...
void DebugGraphicsArrow::RenderArrow()
{
	...
	m_glRenderer.Translatef( m_endPosition.x, m_endPosition.y, m_endPosition.z );
	m_glRenderer.MultMatrixf( rotateMatrix );

	m_glRenderer.BeginRender( LINES );
	{
		m_glRenderer.SetVertex3f( 0.f, 0.f, 0.f );
		m_glRenderer.SetVertex3f( -DEBUG_ARROW_HEAD_LENGTH, -DEBUG_ARROW_HEAD_LENGTH, DEBUG_ARROW_HEAD_LENGTH );
...
void DebugGraphicsArrow::Render()
{
	...
	{
		m_glRenderer.DisableDepthTest();
		m_glRenderer.SetColor4f( m_color.r, m_color.g, m_color.b, m_color.a );
		RenderArrow();
		m_glRenderer.EnableDepthTest();
	}
...
void DebugGraphicsAABB3::RenderAABB3Lines()
{
	...
	m_glRenderer.BeginRender( LINES );
	{
		m_glRenderer.SetVertex3f( xMin, yMin, zMin );
		m_glRenderer.SetVertex3f( xMin, yMax, zMin );

		m_glRenderer.SetVertex3f( xMin, yMin, zMin );
		m_glRenderer.SetVertex3f( xMin, yMin, zMax );

		m_glRenderer.SetVertex3f( xMax, yMin, zMin );
		m_glRenderer.SetVertex3f( xMax, yMax, zMin );

		m_glRenderer.SetVertex3f( xMax, yMin, zMin );
		m_glRenderer.SetVertex3f( xMax, yMin, zMax );
		...
		m_glRenderer.SetVertex3f( xMin, yMax, zMin );
		m_glRenderer.SetVertex3f( xMin, yMax, zMax );

		m_glRenderer.SetVertex3f( xMax, yMax, zMin );
		m_glRenderer.SetVertex3f( xMax, yMax, zMax );
...
void DebugGraphicsAABB3::Render()
{
	...
	m_glRenderer.Translatef( m_boundingBox.m_centerPosition.x, m_boundingBox.m_centerPosition.y, m_boundingBox.m_centerPosition.z );
	m_glRenderer.SetLineWidth( LINE_WIDTH );
	...
	{
		m_glRenderer.DisableDepthTest();
		m_glRenderer.SetColor4f( m_lineColor.r, m_lineColor.g, m_lineColor.b, m_lineColor.a );
		RenderAABB3Lines();

		m_glRenderer.SetColor4f( m_faceColor.r, m_faceColor.g, m_faceColor.b, m_faceColor.a );
		RenderAABB3Faces();
		m_glRenderer.EnableDepthTest();
	}
