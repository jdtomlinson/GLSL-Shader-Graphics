...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::SetActiveTexture( textureUnit texUnit )
{
	if( texUnit == TEXTURE0 )
...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::BindTexture2D( unsigned int textureID )
{
...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::Translatef( float translateX, float translateY, float translateZ )
{
...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::Rotatef( float angleDegree, float rotateX, float rotateY, float rotateZ )
{
...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::SetOrtho( float leftCoord, float rightCoord, float bottomCoord, float topCoord, float zNearDistance, float zFarDistance )
{
...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::SetPerspective( float fovyDegrees, float aspectRatio, float zNearDistance, float zFarDistance )
{
...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::SetVBO( unsigned int* VBOid, const std::vector<Vertex>& vertices )
{
	if( vertices.size() == 0 )
		return;
...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::RenderVertices( const std::vector<Vertex>& vertices, renderType shape )
{
...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::CreateColorFramebufferTexture2D( unsigned int* framebufferColorTexID, textureUnit texUnit, int textureWidth, int textureHeight )
{
...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::CreateDepthFramebufferTexture2D( unsigned int* framebufferDepthTexID, textureUnit texUnit, int textureWidth, int textureHeight )
{
	SetActiveTexture( texUnit );
...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::SetFBO( unsigned int* FBOid, unsigned int framebufferColorTexID, unsigned int framebufferDepthTexID )
{
...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::BindFramebuffer( unsigned int FBOid )
{
	glBindFramebuffer( GL_FRAMEBUFFER, FBOid );
}
...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::DisableFramebuffer()
{
...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::MultMatrixf( const float* mat )
{
	glMultMatrixf( mat );
}
...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::UseShaderProgram( unsigned int shaderProgramID )
{
...
//-----------------------------------------------------------------------------------------------
int OpenGLRenderer::GetUniformLocation( unsigned int shaderProgramID, const char* name )
{
...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::SetUniform1i( int uniformLocation, int val )
{
...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::SetUniform1f( int uniformLocation, float val )
{
...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::SetUniform2f( int uniformLocation, float val0, float val1 )
{
...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::SetUniform3f( int uniformLocation, float val0, float val1, float val2 )
{
...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::SetUniform4f( int uniformLocation, float val0, float val1, float val2, float val3 )
{
...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::SetModelViewProjectionMatrix( int uniformLocation )
{
...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::SetPositionAttribPointer( int attribLocation )
{
...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::SetColorAttribPointer( int attribLocation )
{
...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::SetTexCoordAttribPointer( int attribLocation )
{
...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::SetNormalAttribPointer( int attribLocation )
{
...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::SetTangentAttribPointer( int attribLocation )
{
...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::EnableAttribArray( int attribLocation )
{
...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::DisableAttribArray( int attribLocation )
{
...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::RenderText( const std::string& text, const BitmapFont& font, float fontCellHeight, const Vector2& screenPos )
{
...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::RenderText( const std::string& text, const BitmapFont& font, float fontCellHeight, const Vector2& screenPos, const Color& color )
{
...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::SetTextVertices( std::vector<Vertex>& vertices, const std::string& text, const BitmapFont& font, float fontCellHeight, const Vector2& screenPos )
{
...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::SetTextVertices( std::vector<Vertex>& vertices, const std::string& text, const BitmapFont& font, float fontCellHeight, const Vector2& screenPos, const Color& color )
{
	float bottomLeftCoordX = screenPos.x;
...
//-----------------------------------------------------------------------------------------------
float OpenGLRenderer::CalcTextWidth( const std::string& text, const BitmapFont& font, float fontCellHeight )
{
	float textWidth = 0.f;
